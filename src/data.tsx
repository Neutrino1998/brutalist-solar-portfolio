...
export const PLANETS: PlanetData[] = [
  { id: 'profile', index: '01', radius: 8, speed: 0.13, size: 1.15, title: '简介', subtitle: 'PROFILE', systemLabel: 'MODULE ALPHA', color: '#E8C75A' },
  { id: 'projects', index: '02', radius: 14, speed: 0.09, size: 1.55, title: '作品', subtitle: 'WORKS', systemLabel: 'ARCHIVE BETA', color: '#BE2E21' },
  { id: 'skills', index: '03', radius: 20, speed: 0.065, size: 1.0, title: '技能', subtitle: 'SKILLS', systemLabel: 'SYSTEM GAMMA', color: '#DED8C4' },
  { id: 'contact', index: '04', radius: 26, speed: 0.045, size: 1.3, title: '联系', subtitle: 'CONTACT', systemLabel: 'SIGNAL RELAY', color: '#F0A33A' },
];
